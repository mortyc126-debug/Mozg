// шаг 85: при LNOS=0 движок побитово равен движку шага 84: жизнь, паузы, свободная активность
const A = require('./history/neuron2_s84.js'), B = require('./neuron2.js');
...
console.log(`сид ${seed} (LNOS=${B.CFG.LNOS} DLINE=${B.CFG.DLINE} ORDER=${B.CFG.ORDER}): побитово одинаковы 30000 кругов с паузами и свободной активностью`);
