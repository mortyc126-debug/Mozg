// шаг 82: в пробе строки 8 (только жизнь, без тишины) LFREEZE=1 ничего не меняет -- побитово
...
console.log(`сид ${seed} (LFREEZE=${B.CFG.LFREEZE} ORDER=${B.CFG.ORDER} QPAY=${B.CFG.QPAY}): без тишины побитово одинаковы 30000 кругов`);
