// шаг 82: при LFREEZE=0 движок побитово равен движку шага 81; в пробе строки 8 без тишины -- и при LFREEZE=1: жизнь, паузы, свободная активность
const A = require('./history/neuron2_s81.js'), B = require('./neuron2.js');
...
console.log(`сид ${seed} (LFREEZE=${B.CFG.LFREEZE} DLINE=${B.CFG.DLINE} ORDER=${B.CFG.ORDER}): побитово одинаковы 30000 кругов с паузами и свободной активностью`);
