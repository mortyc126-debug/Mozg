// шаг 80: при QPAY=0 (и без ORDER при любом QPAY) движок побитово равен движку шага 79: жизнь, паузы, свободная активность
const A = require('./history/neuron2_s79.js'), B = require('./neuron2.js');
...
console.log(`сид ${seed} (QPAY=${B.CFG.QPAY} ORDER=${B.CFG.ORDER}): побитово одинаковы 30000 кругов с паузами и свободной активностью`);
