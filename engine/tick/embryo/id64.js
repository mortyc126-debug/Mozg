// зародыш прогона 3 (до шага 61) против шага 64 при DLINE=0: жизнь, паузы, свободная активность -- побитово
const A = require('./history/neuron2_run4d.js'), B = require('./neuron2.js');
