// шаг 86: при IMPRINT=0 движок побитово равен движку шага 85: жизнь, паузы, свободная активность
const A = require('./history/neuron2_s85.js'), B = require('./neuron2.js');
...
console.log(`сид ${seed} (IMPRINT=${B.CFG.IMPRINT} ORDER=${B.CFG.ORDER}): побитово одинаковы 30000 кругов с паузами и свободной активностью`);
