// зародыш прогона 3 против шага 54 при ZVFREEZE 0 и 1: жизнь, паузы, свободная активность -- побитово
const A = require('./history/neuron2_run3c.js'), B = require('./neuron2.js');
