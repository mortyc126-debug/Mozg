// шаг 83: при LEXP=0 движок побитово равен движку шага 82: жизнь, паузы, свободная активность
const A = require('./history/neuron2_s82.js'), B = require('./neuron2.js');
...
console.log(`сид ${seed} (LEXP=${B.CFG.LEXP} DLINE=${B.CFG.DLINE} ORDER=${B.CFG.ORDER}): побитово одинаковы 30000 кругов с паузами и свободной активностью`);
