// зародыш прогона 3 против проб строки 5 при REL3=0 PERTURB=0: жизнь, паузы, свободная активность -- побитово
const A = require('./history/neuron2_run4.js'), B = require('./neuron2.js');
