...
/* ОПОРА ИЛИ СОПУТСТВУЮЩЕЕ СЛЕДСТВИЕ: УДЕРЖИВАЕМОЕ ВМЕШАТЕЛЬСТВО В q
   ...
   ПРАВИЛО ЧТЕНИЯ, объявлено до запуска:
     ...
     * если знак прогиба переворачивается в B не менее чем на 10 сидах
       из 12, ПРИ ТОМ ЧТО в C он переворачивается не более чем на 2, --
       сторона прогиба задаётся знаком локальной асимметрии, и
       формулировка этапа 13 остаётся по существу, но слово "опора"
       заменяется: опора не внешняя, а собственная;
     * если знак в B не переворачивается (не более 2 из 12) -- сторона
       задаётся не им, q лишь сопутствует, и вывод этапа 13 о
       направлении отзывается;
     * прочее -- неопределённо, ни один вывод не записывается.
