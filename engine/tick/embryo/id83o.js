// шаг 83: в пробе строки 8 (только жизнь, без тишины) LEXP=1 ничего не меняет -- побитово
...
console.log(`сид ${seed} (LEXP=${B.CFG.LEXP} ORDER=${B.CFG.ORDER} QPAY=${B.CFG.QPAY}): без тишины побитово одинаковы 30000 кругов`);
