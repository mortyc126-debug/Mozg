// Проверка устойчивости шага 83 (PRE83_LEXP.md §3): путь батареи до строки 0 и её 200 пауз; катастрофы по росту в паузе и H(10), H(30)
...
console.log([seed, cat, gmax.toExponential(3), f(Hs[10]), f(Hs[30])].join('\t')); process.exit(0);
