// зародыш прогона 3 против рычагов шага 60 при PROTECTQ=0 QDELAY=0: жизнь, паузы, свободная активность -- побитово
const A = require('./history/neuron2_run4c.js'), B = require('./neuron2.js');
