// шаг 84: при LCAP=0 движок побитово равен движку шага 83: жизнь, паузы, свободная активность
...
console.log(`сид ${seed} (LCAP=${B.CFG.LCAP} LEXP=${B.CFG.LEXP} DLINE=${B.CFG.DLINE} ORDER=${B.CFG.ORDER}): побитово одинаковы 30000 кругов с паузами и свободной активностью`);
