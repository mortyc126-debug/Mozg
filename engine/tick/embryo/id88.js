// шаг 88: при ISLOW=0 движок побитово равен движку шага 87: жизнь, паузы, свободная активность
const A = require('./history/neuron2_s87.js'), B = require('./neuron2.js');
...
console.log(`сид ${seed} (ISLOW=${B.CFG.ISLOW} IMPRINT=${B.CFG.IMPRINT} ORDER=${B.CFG.ORDER}): побитово одинаковы 30000 кругов с паузами и свободной активностью`);
