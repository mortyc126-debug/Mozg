// Данные для PRE63_HSTAT.md (из h30.js шага 62): старая мера (20 циклов по 200 кругов, два повтора) против новой (100 циклов по 100 кругов, половины).
...
// шаг 63: только новый протокол, на выход -- суммы по половинам (ткань, нуль, оптимум)
const out = [seed];
for (const T of [10, 30]) { const h1 = acc(), h2 = acc(); cycles(100, 100, T, (c) => (c < 50 ? h1 : h2)); for (const a of [h1, h2]) out.push(a.net.toFixed(6), a.nul.toFixed(6), a.kal.toFixed(6)); }
