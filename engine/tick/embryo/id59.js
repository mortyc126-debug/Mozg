// зародыш прогона 3 против пробы строки 8 при ORDER=0: жизнь, паузы, свободная активность -- побитово
const A = require('./history/neuron2_run4b.js'), B = require('./neuron2.js');
