// шаг 69: при ORDERTSHUF=0 движок побитово равен движку шага 68, в том числе с CSEARCH: жизнь, паузы, свободная активность
const A = require('./history/neuron2_s68.js'), B = require('./neuron2.js');
...
console.log(`сид ${seed} (CSEARCH=${B.CFG.CSEARCH} ORDER=${B.CFG.ORDER} DLINE=${B.CFG.DLINE}): побитово одинаковы 30000 кругов с паузами и свободной активностью`);
