// зародыш прогона 1 против зародыша шага 48 при ECOSLEEP=0 RELPRUNE=0: жизнь, паузы, свободная активность -- побитово
const A = require('./history/neuron2_run1.js'), B = require('./neuron2.js');
