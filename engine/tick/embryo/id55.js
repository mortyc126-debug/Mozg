// зародыш прогона 3 против шага 55 при WAKEGRACE=0: жизнь, паузы, свободная активность -- побитово
const A = require('./history/neuron2_run3d.js'), B = require('./neuron2.js');
