// зародыш прогона 3 против шага 52 при NOFAULTQUIET=0: жизнь, паузы, свободная активность -- побитово
const A = require('./history/neuron2_run3b.js'), B = require('./neuron2.js');
