// шаг 72: при HOLDS=0 движок побитово равен движку шага 71: жизнь, паузы, свободная активность
const A = require('./history/neuron2_s71.js'), B = require('./neuron2.js');
...
console.log(`сид ${seed} (HOLDS=${B.CFG.HOLDS}): побитово одинаковы 30000 кругов с паузами и свободной активностью`);
